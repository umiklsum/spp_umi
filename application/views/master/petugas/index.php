                ...
                <form method="post" action="<?= base_url('masterdata/petugas_pass') ?>">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control password-hide" id="password1" name="password1">
                            <small class="text-secondary">Password harus 8 digit.</small>
                            <?= form_error('password1', '<small class="text-danger ml-2">', '</small>'); ?>
                        </div>
                        <div class=" form-group">
                            <label for="password2">Ulangi Password</label>
                            <input type="password" class="form-control password-hide" id="password2" name="password2">
...
<script type="text/javascript">
    ...
    function myFunction() {
        var pw = document.getElementsByClassName("password-hide");
