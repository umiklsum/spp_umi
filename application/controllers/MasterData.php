...
class MasterData extends CI_Controller
{
    ...
    public function list_petugas()
    {
        ...
        foreach ($data as $petugas) {
            ...
            // echo '<td> **********</td>'; (untuk menyembunyikan password)
            echo '<td>' . $petugas->DESKRIPSI . '</td>';
            echo '<td>' . $petugas->NAMA_PETUGAS . '</td>';
            echo '<td>
                <a href="#" data-toggle="modal" data-target="#modalEdit' . $petugas->ID_PETUGAS . '" class="btn btn-sm btn-primary" data-popup="tooltip" data-placement="top" title="Edit Data">Edit</a>
                <a href="' . base_url('masterdata/petugas_del/') .  $petugas->ID_PETUGAS . '" class="btn btn-sm btn-secondary tombol-hapus">Hapus</a>
                </td>';
            echo '</tr>';
            echo "<script>
    ...
    public function list_siswa()
    {
        ...
        foreach ($data as $siswa) {
            ...
            echo '<td>
                <a href="#" data-toggle="modal" data-target="#modalEdit' . $siswa->NISN . '" class="btn btn-sm btn-primary" data-popup="tooltip" data-placement="top" title="Edit Data">Edit</a>
                <a href="' . base_url('masterdata/siswa_del/') .  $siswa->NISN . '" class="btn btn-sm btn-secondary tombol-hapus"  id="delete" name="delete">Hapus</a>
                </td>';
            echo '</tr>';
            echo "<script>
                     $('.tombol-hapus').on('click', function(e) {
    ...
    public function add_siswa()
    {
        ...
        $this->form_validation->set_rules('NIS', 'NIS', 'required|trim|is_unique[tbl_siswa.NIS]|min_length[8]|numeric', [
        ...
        $this->form_validation->set_rules('no_telp', 'No.Telp', 'required|trim|min_length[13]|numeric', [
    ...
    public function list_spp()
    {
        ...
        foreach ($data as $spp) {
            ...
            echo '<td>
                <a href="#" data-toggle="modal" data-target="#modalEdit' . $spp->ID_SPP . '" class="btn btn-sm btn-primary" data-popup="tooltip" data-placement="top" title="Edit Data">Edit</a>
                <a href="' . base_url('masterdata/spp_del/') .  $spp->ID_SPP . '" class="btn btn-sm btn-secondary tombol-hapus"  id="delete" name="delete">Hapus</a>
                </td>';
            echo '</tr>';
             echo "<script>
                     $('.tombol-hapus').on('click', function(e) {
    ...
    public function list_kelas()
    {
        ...
        foreach ($data as $kelas) {
            ...
            echo '<td>
                <a href="#" data-toggle="modal" data-target="#modalEdit' . $kelas->ID_KELAS . '" class="btn btn-sm btn-primary" data-popup="tooltip" data-placement="top" title="Edit Data">Edit</a>
                <a href="' . base_url('masterdata/kelas_del/') .  $kelas->ID_KELAS . '" class="btn btn-sm btn-secondary tombol-hapus"  id="delete" name="delete">Hapus</a>
                </td>';
            echo '</tr>';
            echo "<script>
                     $('.tombol-hapus').on('click', function(e) {
    ...
    public function jurusan()
    {
        ...
        $this->form_validation->set_rules('jurusan', 'Jurusan', 'required|is_unique[tbl_jurusan.jurusan]', [
            'required' => 'Kompetensi Keahlian tidak boleh kosong.',
            'is_unique' => 'Kompetensi Keahlian Yang Anda Tambahkan Sudah Ada!',
        ]);
    ...
    public function list_jurusan()
    {
        ...
        foreach ($data as $jurusan) {
            ...
            echo '<td>
                <a href="#" data-toggle="modal" data-target="#modalEdit' . $jurusan->ID_JURUSAN . '" class="btn btn-sm btn-primary" data-popup="tooltip" data-placement="top" title="Edit Data">Edit</a>
                <a href="' . base_url('masterdata/jurusan_del/') .  $jurusan->ID_JURUSAN . '" class="btn btn-sm btn-secondary tombol-hapus"  id="delete" name="delete">Hapus</a>
                </td>';
            echo '</tr>';
            echo "<script>
                     $('.tombol-hapus').on('click', function(e) {
